...
public class Curve25519 {
    ...
    public Curve25519() {
        ...
        this.publicKey  = Curve25519.generatePublicKey(this.privateKey);
    }

    public Curve25519(byte[] random) {
        this.privateKey = Curve25519.generatePrivateKey(random);
        this.publicKey  = Curve25519.generatePublicKey(this.privateKey);
    }
    ...
    public byte[] generateSharedSecret(byte[] peerPublicKey) {
        byte[] sharedSecret = new byte[32];

        curve(sharedSecret, this.privateKey, peerPublicKey);
    ...
    public static byte[] generatePrivateKey() {
        return generatePrivateKey(RBGHelper.rbg(KEY_SIZE));
    }

    public static byte[] generatePrivateKey(byte[] random) {
